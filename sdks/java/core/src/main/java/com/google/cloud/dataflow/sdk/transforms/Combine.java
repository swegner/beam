...
public class Combine {
  ...
  public static <V> Globally<V, V> globally(
    ...
    return globally(IterableCombineFn.of(combiner), getClassSafe(combiner));
  }
  ...
  public static <InputT, OutputT> Globally<InputT, OutputT> globally(
    ...
    return globally(fn, getClassSafe(fn));
  }

  private static <InputT, OutputT> Globally<InputT, OutputT> globally(
          GlobalCombineFn<? super InputT, ?, OutputT> fn, Class<?> fnClass) {
  ...
  public static <K, V> PerKey<K, V, V> perKey(
    ...
    return perKey(IterableCombineFn.of(fn).<K>asKeyedFn(), getClassSafe(fn));
  }
  ...
  public static <K, InputT, OutputT> PerKey<K, InputT, OutputT> perKey(
      GlobalCombineFn<? super InputT, ?, OutputT> fn) {
    return perKey(fn.<K>asKeyedFn(), getClassSafe(fn));
  }
  ...
  public static <K, InputT, OutputT> PerKey<K, InputT, OutputT> perKey(
    ...
    return perKey(fn, getClassSafe(fn));
  }

  private static <K, InputT, OutputT> PerKey<K, InputT, OutputT> perKey(
          PerKeyCombineFn<? super K, ? super InputT, ?, OutputT> fn, Class<?> fnClass) {
  ...
  public static <K, V> GroupedValues<K, V, V> groupedValues(
      SerializableFunction<Iterable<V>, V> fn) {
    return groupedValues(IterableCombineFn.of(fn).<K>asKeyedFn(), getClassSafe(fn));
  }
  ...
  public static <K, InputT, OutputT> GroupedValues<K, InputT, OutputT> groupedValues(
      GlobalCombineFn<? super InputT, ?, OutputT> fn) {
    return groupedValues(fn.<K>asKeyedFn(), getClassSafe(fn));
  }
  ...
  public static <K, InputT, OutputT> GroupedValues<K, InputT, OutputT> groupedValues(
      PerKeyCombineFn<? super K, ? super InputT, ?, OutputT> fn) {
    return groupedValues(fn, getClassSafe(fn));
  }
  ...
  private static Class<?> getClassSafe(Object fn) {
    Class<?> fnClass = fn.getClass();
    if (fnClass.isSynthetic()) {
      // Lambda classes break serialization.
      fnClass = null;
    }
    return fnClass;
  }
  ...
  public static class Globally<InputT, OutputT>
    ...
    private Globally(GlobalCombineFn<? super InputT, ?, OutputT> fn, Class<?> fnClass,
    ...
    private Globally(String name, GlobalCombineFn<? super InputT, ?, OutputT> fn,
        Class<?> fnClass, boolean insertDefault, int fanout) {
      super(name);
      this.fn = fn;
      this.fnClass = fnClass;
      this.insertDefault = insertDefault;
    ...
    private Globally(String name, GlobalCombineFn<? super InputT, ?, OutputT> fn,
        Class<?> fnClass, boolean insertDefault, int fanout, List<PCollectionView<?>> sideInputs) {
      super(name);
      this.fn = fn;
      this.fnClass = fnClass;
      this.insertDefault = insertDefault;
  ...
  private static void populateDisplayData(
        DisplayData.Builder builder, HasDisplayData fn, Class<?> fnClass) {
    if (fnClass != null) {
      builder
          .include(fn, fnClass)
  ...
  public static class PerKey<K, InputT, OutputT>
    ...
    private PerKey(
        String name, PerKeyCombineFn<? super K, ? super InputT, ?, OutputT> fn, Class<?> fnClass,
        boolean fewKeys) {
      super(name);
      this.fn = fn;
      this.fnClass = fnClass;
